...
async function reactPresenter(node, response, componentName, _option) {
	...
	if (!Component) {
		console.warn(`React component "${componentName}" not registered. Use registerComponent("${componentName}", MyComponent).`);
		return;
	}
	...
	root.render((0, import_react.createElement)(Component, { data }));
}
...
//#endregion
export { react_default as default, getComponent, hasComponent, registerComponent };
