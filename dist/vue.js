...
const apps = /* @__PURE__ */ new WeakMap();
...
async function vuePresenter(node, response, componentName, _option) {
	...
	if (!Component) {
		console.warn(`Vue component "${componentName}" not registered. Use registerComponent("${componentName}", MyComponent).`);
		return;
	}
...
//#endregion
export { vue_default as default, getComponent, hasComponent, registerComponent };
